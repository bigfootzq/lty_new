 ...
 * 基于Zepto的touch.js
 * ------touch.js------start------
 * 更新：2018-02-06 17:49:52 by zhaoyf 更新至最新版
*/
;(function($){
    var touch = {},
    ...
    ;['swipe', 'swipeLeft', 'swipeRight', 'swipeUp', 'swipeDown',
      ...
      $.fn[eventName] = function(callback){ return this.on(eventName, callback) }
        ...
        /**
         * 修改 by zhaoyf 2017-03-28 14:29:59
         * 修改内容：将 触发事件'longTap' 改为 'longtap'，共两处。
         * 修改内容：将 触发事件'doubleTap' 改为 'doubletap'，共两处。
         * 修改内容：将 触发事件'singleTap' 改为 'singletap'，共两处。
         * 修改原因：Vue框架绑定事件时会将事件键值小写化，因此 'longTap' 事件无法触发
         */
    $.touch = { setup: setup }
